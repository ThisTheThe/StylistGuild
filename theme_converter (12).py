...
def json_to_csv():
    ...
    with open('community-css-themes-tag-browser.csv', 'w', newline='', encoding='utf-8') as f:
        writer = csv.DictWriter(f, fieldnames=['github-link', 'repo', 'screenshot-main', 'screenshots-side', 'tags', 'repo_created'])
        writer.writeheader()
...
def csv_to_json():
    ...
    with open('community-css-themes-tag-browser.csv', 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            # Split screenshots-side by pipe, tags by semicolon
